...
public class VariationalAutoEncoderExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        double plotMin = -40;                //Minimum values for plotting (x and y dimensions)
        double plotMax = 40;                 //Maximum values for plotting (x and y dimensions)
        int plotNumSteps = 16;              //Number of steps for reconstructions, between plotMin and plotMax

        //MNIST data for training
         String _filenameTrain  = new ClassPathResource("OneClass/training_raul.csv").getFile().getPath();
        String _filenameTest  = new ClassPathResource("OneClass/eval_raul.csv").getFile().getPath();
        ...
        DataSet testdata = _testIter.next(3000);
